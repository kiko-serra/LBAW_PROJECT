<article class="flex flex-row bg-gray-100 rounded-lg pl-4 pt-4 pb-2 pr-4 m-4" href="/post/{{ $post->id_post }}">
  ...
  <div id="postCardRightBar" class="flex flex-row justify-between w-full break-all">
    ...
    <div id="postCardInfo" class="flex flex-col justify-between ml-7 pt-2 pb-2 items-center justify-center justify-items-center">
